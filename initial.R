...
# You have to email me @ abhik1368@gmail.com for below datasets
...
## A user might change to different classes like N or A
...
new.df<-rbind(adrs.a[1:55,],n1.df[1:55,])
